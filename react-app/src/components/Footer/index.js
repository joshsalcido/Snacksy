    ...
    <div className='footer'>
      ...
      <div className='footer-content'>
        <div className='footer-developer'>
          ...
          <p>Josh Salcido</p>
          <div id='dev-links'>
            <a id='anchor-links' href='https://github.com/joshsalcido'><i class="fa-brands fa-square-github fa-2x"></i></a>
        ...
        <div className='footer-developer'>
          ...
          <p>Amy Lopez</p>
          <div id='dev-links'>
            <a id='anchor-links' href='https://github.com/anailopez'><i class="fa-brands fa-square-github fa-2x"></i></a>
        ...
        <img alt='dev-img' id='dev-img' src='https://i.postimg.cc/q7p9bWSp/100002251.jpg'></img>
          <p>Mineh Gharabegi</p>
          <div id='dev-links'>
            <a id='anchor-links' href='https://github.com/Mineh222'><i class="fa-brands fa-square-github fa-2x"></i></a>
        ...
        <div className='footer-developer'>
          ...
          <p>Michael Dasch</p>
          <div id='dev-links'>
            <a id='anchor-links' href='https://github.com/MDasch22'><i class="fa-brands fa-square-github fa-2x"></i></a>
